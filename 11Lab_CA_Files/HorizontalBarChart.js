class HorizontalBarChart {
	...
	render(){
		...
		text("Value as " + this.xAxisLabel, this.chartWidth/2 - 100, this.chartHeight/this.chartHeight - 100, 300);
		pop();

		text("Value as " + this.yAxisLabel, this.chartWidth/2-50, this.chartHeight/this.chartHeight + 80, 250);
